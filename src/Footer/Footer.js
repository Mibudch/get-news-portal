                    ...
                    <div className='footer__bottom__block'>
                        <div className='footer__disclaimer__container'>
                            ...
                            <div className='footer__disclaimer__bottom'>
                                «GetNews» - платформа является авторским некоммерческим продуктом. Создана как один из элементов портфолио разработчика, исключительно в целях наглядной демонстрации умений и навыков создателя.  Логотип «GetNews» является авторским и принадлежит его создателю. Все API ссылки взяты из открытых источников. Разработчик не претендует на авторство новостных статей, демонстрируемых на портале «GetNews», и не несёт ответственности за их содержимое.
                        </div>
                        </div>
