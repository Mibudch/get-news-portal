...
function SectionLeftAlign(props) {
    ...
    return (
        <section >
            <div className='section__separator _bg' onClick={handlerOnClick}><div className='section__separator _fade'><div className='section__catecory section__catecory_left-align'>{props.firstNews.category.toUpperCase()}</div></div></div>
