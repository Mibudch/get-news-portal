...
export const getBusinessNewsAPI = () => (axios.get(`http://newsapi.org/v2/top-headlines?pageSize=10&category=business&country=ru&apiKey=7a824e553994401584147a79cbf9129f`))
