...
export const getNewsAPI = (newsCategory) => (axios.get(`http://newsapi.org/v2/top-headlines?pageSize=100&category=${newsCategory}&country=ru&apiKey=7a824e553994401584147a79cbf9129f`))
