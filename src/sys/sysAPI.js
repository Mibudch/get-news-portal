...
export const getNewsSearchAPI = (searchRequest) => (axios.get(`https://newsapi.org/v2/everything?q=${searchRequest}&language=ru&apiKey=7a824e553994401584147a79cbf9129f`))
